      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="Find.php">Find</a></li>
            <!-- <li><a class="nav-link scrollto" href="#services">Batch</a></li> -->
            <li><a class="nav-link   scrollto" href="SM.php">Student Management</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h1>School that promises Skills</h1>
    ...
    <main id="main">
      ...
      <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h2>Batch</h2>
            <p>Batch of nowwhere<?php echo " from ".$Ssem." to ".$Lsem ?></p>
          </div>
            ...
            <tbody>
              <?php
                $sql = "SELECT *
                    ...
                    join st_record
                    ON st_data.roll_no = st_record.roll_no  
                    where semester between ".$Ssem." and ".$Lsem." order by semester asc ;";
                $result = mysqli_query($conn, $sql);
                $resultCheck = mysqli_num_rows($result);
    ...
    <footer id="footer">
      ...
      <div class="container footer-bottom clearfix">
        ...
        <div class="credits">
          ...
          Designed by Copy, Copy, Change, Change 
        </div>
      </div>
    </footer><!-- End Footer -->
